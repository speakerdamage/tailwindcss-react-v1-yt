...
const Hero = () => {
  return (
    <div className='br-white h-screen flex flex-col justify-center items-center'>
      <h1 class="lg:text-9xl md:text-7xl sm:text-5xl text-3xl font-black mb-14">EGGCELLENT</h1>
